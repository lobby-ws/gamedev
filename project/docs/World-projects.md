...
dist/apps/                  Legacy bundled app scripts (generated, gitignored)
...
- `apps/<AppName>/index.ts` (or `index.js`) for entry scripts.
- `apps/<AppName>/**/*.ts` or `.js` for module helpers when `scriptFormat` is set.
...
- `dist/` is generated by the legacy bundler.
